        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="block mb-8">
                <a href="{{ route('settings.create') }}"
                   class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">{{ __('Добавить') }}</a>
            </div>
            ...
            @if ($message = Session::get('success'))
                <div id="alert-additional-content-3"
                    ...
                    <div class="flex items-center">
                        <svg aria-hidden="true" class="w-5 h-5 mr-2 text-green-700 dark:text-green-800"
                    ...
                    <div class="flex">
                        ...
                        <button id="targetElement" type="button"
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                @foreach ($settings as $setting)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {{ Str::limit($setting->site_title, 200) }}
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {{ Str::limit($setting->site_header, 200) }}
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('settings.edit', $setting->id) }}"
                                               class="text-blue-600 hover:text-blue-900 mb-2 mr-2">
                                                <button
                                                    class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">{{ __('Обновить') }}</button>
                                            </a>
{{--                                            <a href="{{ route('teachers.show', $teacher->id) }}"--}}
{{--                                               class="text-blue-600 hover:text-blue-900 mb-2 mr-2">--}}
{{--                                                <button--}}
{{--                                                    class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">{{ __('Подробнее') }}</button>--}}
{{--                                            </a>--}}
                                            <form class="inline-block"
                                                  action="{{ route('documents.destroy', $setting->id) }}"
