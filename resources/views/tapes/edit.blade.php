                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select id="published_slider_status" name="published_slider_status"
                                ...
                                class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option value="{{ old('published_slider_status' . $tape->published_slider_status) }}">
                                    {{ __('Выберите значанеи') }}</option>
                                <option value="{{ old('published_slider_status' . $tape->published_slider_status) }}">
                                    {{ __('Нет') }}</option>
                                <option
                                    value="{{ old('published_slider_status', $tape->published_slider_status) }} ">
                                    {{ __('Да') }}</option>
                            </select>
                        </div>
