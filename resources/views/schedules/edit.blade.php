        ...
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="block mb-8">
                <a href="{{ route('schedules.index') }}"
                   class="bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded">{{ __('< Название расписания') }}</a>
            </div>
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <div class="shadow overflow-hidden sm:rounded-md">
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <label for="name"
                               class="block font-medium text-sm text-gray-700">{{ __('Название расписания') }}</label>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <label for="link_schedule"
                               class="block font-medium text-sm text-gray-700">{{ __('Ссылка на расписание') }}</label>
                        <input type="text" name="link_schedule" id="link_schedule" type="text"
                               class="form-input rounded-md shadow-sm mt-1 block w-full"
                               value="{{ old('link_schedule', $schedule->link_schedule) }}" />
                        @error('link_schedule')
                        <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <label for="comments" class="block font-medium text-sm text-gray-700">{{ __('Комментарий (не обязательно)') }}</label>
